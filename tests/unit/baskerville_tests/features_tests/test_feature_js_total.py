...
class TestSparkJsTotal(FeatureSparkTestCase):

    def setUp(self):
        super(TestSparkJsTotal, self).setUp()
        self.feature = FeatureJsTotal()
    ...
    def test_instance(self):
        ...
        self.assertTrue(self.feature.feature_name == 'js_total')
