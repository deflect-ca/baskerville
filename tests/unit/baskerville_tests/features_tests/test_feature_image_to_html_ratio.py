...
class TestSparkImageToHtmlRatio(FeatureSparkTestCase):

    def setUp(self):
        super(TestSparkImageToHtmlRatio, self).setUp()
        self.feature = FeatureImageToHtmlRatio()
    ...
    def test_instance(self):
        ...
        self.assertTrue(self.feature.feature_name == 'image_to_html_ratio')
        self.assertTrue(self.feature.columns == ['content_type'])
        self.assertTrue(self.feature.dependencies == [FeatureImageTotal,
                                                      FeatureHtmlTotal])
