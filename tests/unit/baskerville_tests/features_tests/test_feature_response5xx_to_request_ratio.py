...
from baskerville.features.feature_response5xx_to_request_ratio import \
    FeatureResponse5xxToRequestRatio, FeatureResponse5xxTotal, FeatureRequestTotal

from tests.unit.baskerville_tests.helpers.spark_testing_base import \
    FeatureSparkTestCase


class TestSparkResponse5xxToRequestRatio(FeatureSparkTestCase):

    def setUp(self):
        super(TestSparkResponse5xxToRequestRatio, self).setUp()
        self.feature = FeatureResponse5xxToRequestRatio()
    ...
    def test_update_row(self):
        ...
        numerator = FeatureResponse5xxTotal()
