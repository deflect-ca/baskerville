...
class TestSparkResponse4xxTotal(FeatureSparkTestCase):

    def setUp(self):
        super(TestSparkResponse4xxTotal, self).setUp()
        self.feature = FeatureResponse4xxTotal()
    ...
    def test_instance(self):
        ...
        self.assertTrue(self.feature.feature_name == 'response4xx_total')
        self.assertTrue(
