...
class TestSparkCssTotal(FeatureSparkTestCase):

    def setUp(self):
        super(TestSparkCssTotal, self).setUp()
        self.feature = FeatureCssTotal()
    ...
    def test_instance(self):
        ...
        self.assertTrue(self.feature.feature_name == 'css_total')
