...
from baskerville.features.feature_unique_ua_to_request_ratio import \
    FeatureUniqueUaToRequestRatio, FeatureRequestTotal, FeatureUniqueUaTotal

from tests.unit.baskerville_tests.helpers.spark_testing_base import \
    FeatureSparkTestCase


class TestSparkUniqueUaToRequestRatio(FeatureSparkTestCase):

    def setUp(self):
        super(TestSparkUniqueUaToRequestRatio, self).setUp()
        self.feature = FeatureUniqueUaToRequestRatio()
    ...
    def test_compute_multiple_records_different_uas(self):
        first_ats_record = {
            "client_ip": '55.555.55.55',
            "@timestamp": '2018-01-17T08:30:00.000Z',
            "content_type": 'html',
    ...
    def test_compute_multiple_records_same_ua(self):
        first_ats_record = {
            "client_ip": '55.555.55.55',
            "@timestamp": '2018-01-17T08:30:00.000Z',
            "content_type": 'html',
    ...
    def test_update_row(self):
        ...
        numerator = FeatureUniqueUaTotal()
