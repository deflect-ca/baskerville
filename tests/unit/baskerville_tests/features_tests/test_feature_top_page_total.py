...
class TestSparkTopPageTotal(FeatureSparkTestCase):

    def setUp(self):
        super(TestSparkTopPageTotal, self).setUp()
        self.feature = FeatureTopPageTotal()
    ...
    def test_instance(self):
        ...
        self.assertTrue(self.feature.feature_name == 'top_page_total')
        self.assertTrue(
