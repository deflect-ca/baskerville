...
from baskerville.features.feature_response5xx_rate import FeatureResponse5xxRate, \
    FeatureMinutesTotal, FeatureResponse5xxTotal

from tests.unit.baskerville_tests.helpers.spark_testing_base import \
    FeatureSparkTestCase


class TestSparkResponse5xxRate(FeatureSparkTestCase):

    def setUp(self):
        super(TestSparkResponse5xxRate, self).setUp()
        self.feature = FeatureResponse5xxRate()
    ...
    def test_instance(self):
        ...
        self.assertTrue(self.feature.feature_name == 'response5xx_rate')
        self.assertTrue(
